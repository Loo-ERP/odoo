...
class AccountInvoice(models.Model):
    ...
    def _compute_amount(self):
        ...
        if self.currency_id and self.company_id and self.currency_id != self.company_id.currency_id:
            ...
            amount_tax_company_signed = currency_id._convert(self.amount_tax, self.company_id.currency_id, self.company_id, rate_date)
    ...
    amount_tax = fields.Monetary(string='Tax',
        store=True, readonly=True, compute='_compute_amount')
    amount_tax_company_signed = fields.Monetary(string='Tax in Company Currency', currency_field='company_currency_id',
        store=True, readonly=True, compute='_compute_amount')
