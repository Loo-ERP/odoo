...
class SaleReport(models.Model):
    ...
    def _select_pos(self, fields={}):
        select_pos = '''
            ...
            SUM(COALESCE((l.price_subtotal_incl * u.factor), l.price_subtotal_incl)) / MIN(CASE COALESCE(pos.currency_rate, 0) WHEN 0 THEN 1.0 ELSE pos.currency_rate END) AS price_total,
            SUM(COALESCE((l.price_subtotal * u.factor), l.price_subtotal)) / MIN(CASE COALESCE(pos.currency_rate, 0) WHEN 0 THEN 1.0 ELSE pos.currency_rate END) AS price_subtotal,
            SUM(COALESCE(((l.price_subtotal_incl-l.price_subtotal) * u.factor), (l.price_subtotal_incl-l.price_subtotal))) / MIN(CASE COALESCE(pos.currency_rate, 0) WHEN 0 THEN 1.0 ELSE pos.currency_rate END) AS price_tax,
            CASE WHEN pos.state != 'invoiced' THEN SUM(COALESCE((l.price_subtotal * u.factor), l.price_subtotal)) ELSE 0 END / MIN(CASE COALESCE(pos.currency_rate, 0) WHEN 0 THEN 1.0 ELSE pos.currency_rate END) AS amount_to_invoice,
            CASE WHEN pos.state = 'invoiced' THEN SUM(COALESCE((l.price_subtotal * u.factor), l.price_subtotal)) ELSE 0 END / MIN(CASE COALESCE(pos.currency_rate, 0) WHEN 0 THEN 1.0 ELSE pos.currency_rate END) AS amount_invoiced,
            count(*) AS nbr,
